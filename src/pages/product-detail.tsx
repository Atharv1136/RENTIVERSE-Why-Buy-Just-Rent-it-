          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-renti-teal font-semibold mt-2">
                ₹{product.basePrice}/{product.rentalDuration}
              </p>
            </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">
                        Seller: {product.seller.fullName || product.seller.username}
                      </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-700">{product.availableUnits}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-gray-700">{product.minRentalPeriod} {product.rentalDuration}</p>
              </div>
              <div>
            ...
            {user?.role === 'customer' && product.isActive && (
